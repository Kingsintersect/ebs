...
export const baseUrl = process.env.NEXT_PUBLIC_BASE_URL_EBS ?? "";
export const apiUrl = (process.env.NEXT_PUBLIC_BASE_URL_EBS ?? "") + "/api";
...
export const lmsLoginUrl = process.env.NEXT_PUBLIC_LMS_LOGIN_URL_EBS ?? "";
...
export const sessionSecret = process.env.NEXT_PUBLIC_SESSION_SECRET_EBS ?? "";
export const sessionPassword =
	process.env.NEXT_PUBLIC_SESSION_PASSWORD_EBS ?? "";

// TOKENS CONFIG
export const accessTokenSecret =
	process.env.NEXT_PUBLIC_ACCESS_TOKEN_SECRET_EBS ?? "";
export const refreshTokenSecret =
	process.env.NEXT_PUBLIC_REFRESH_TOKEN_SECRET_EBS ?? "";


// JWT CONFIGS
export const clientId = process.env.NEXT_PUBLIC_CLIENT_ID_EBS ?? "";
export const clientSecret = process.env.NEXT_PUBLIC_CLIENT_SECRET_EBS ?? "";

const secretKey = process.env.NEXT_PUBLIC_SESSION_SECRET_EBS;
